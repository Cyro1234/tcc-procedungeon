...
public class DebuffTester : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        // Se os scripts estiverem em outros objetos, voc� precisar� de outra l�gica
    ...
    private void Update()
    {
        ...
        // Se o caractere for um d�gito de 1 a 9
        // if (char.IsDigit(c) && c != '0')
        // {
        //     // Converte o caractere para int (ex: '1' vira 1) e subtrai 1 para o �ndice da lista
